                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-10 mb-10">
                            ...
                            <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] border-l-4 border-[#FFB81A] group">
                                <div className="p-6 md:p-8 flex flex-col md:flex-row items-center">
                                    <div className="mb-4 md:mb-0 md:mr-6 group-hover:scale-110 transition-all duration-300">
                                        <div className="image-container">
                                            <svg xmlns="http://www.w3.org/2000/svg" className="original-image mx-auto w-16 h-16 group-hover:hidden text-[#FFB81A]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                            </svg>
                                            <svg xmlns="http://www.w3.org/2000/svg" className="hover-image mx-auto w-16 h-16 hidden group-hover:block text-[#ffce63]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                            </svg>
                                        </div>
                                    </div>
                                    <div className="flex-1 text-center md:text-left">
                                        <h3 className="font-playfair text-xl font-bold text-gray-900 mb-2">Talleres</h3>
                                        <p className="text-gray-600 mb-4">Participe en nuestros talleres comunitarios diseñados para el desarrollo social y personal.</p>
                                        <Link
                                            href="/area-social/talleres"
                                            className="inline-flex items-center px-6 py-3 bg-[#FFB81A] text-gray-900 font-bold rounded-full shadow-md transition-all duration-300 hover:shadow-lg hover:bg-[#ffce63]"
                                        >
                                            Ver Talleres
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2" viewBox="0 0 20 20" fill="currentColor">
                            ...
                            <div className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300 transform hover:scale-[1.02] border-l-4 border-[#FFB81A] group">
                                <div className="p-6 md:p-8 flex flex-col md:flex-row items-center">
                                    ...
                                    <div className="flex-1 text-center md:text-left">
                                        <h3 className="text-xl font-bold text-gray-900 mb-2">Programas</h3>
                                        <p className="text-gray-600 mb-4">Conozca nuestros programas sociales diseñados para mejorar la calidad de vida de la comunidad.</p>
                                        <Link
                                            href="/area-social/programas"
                                            className="inline-flex items-center px-6 py-3 bg-[#FFB81A] text-gray-900 font-bold rounded-full shadow-md transition-all duration-300 hover:shadow-lg hover:bg-[#ffce63]"
                                        >
                                            Ver Programas
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-2" viewBox="0 0 20 20" fill="currentColor">
