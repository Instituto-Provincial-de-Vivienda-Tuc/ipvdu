                        ...
                        <ul className="text-xl font-bold flex flex-col md:flex-row p-4 md:p-0 mt-4 rounded-lg md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white">
                            <li className="mb-2 md:mb-0 transform transition-transform duration-300 hover:translate-y-[-2px]">
                                <Link
                                    ...
                                    scroll={false}
                                    className={`block py-2 px-3 rounded-md transition-all duration-300 relative ${pathname === '/institucional/mision'
                                        ? 'text-[#FFB81A]'
                                        : 'text-gray-700 hover:text-[#FFB81A]'
                                        }`}
                                >
                                    Misión
                                    <span className={`absolute bottom-0 left-0 w-full h-0.5 bg-[#FFB81A] transform transition-transform duration-300 ${pathname === '/institucional/mision' ? 'scale-x-100' : 'scale-x-0 hover:scale-x-100'
                                        }`}></span>
                                </Link>
                            </li>
                            <li className="mb-2 md:mb-0 transform transition-transform duration-300 hover:translate-y-[-2px]">
                                <Link
                                    ...
                                    scroll={false}
                                    className={`block py-2 px-3 rounded-md transition-all duration-300 relative ${pathname === '/institucional/autoridades'
                                        ? 'text-[#FFB81A]'
                                        : 'text-gray-700 hover:text-[#FFB81A]'
                                        }`}
                                >
                                    Autoridades
                                    <span className={`absolute bottom-0 left-0 w-full h-0.5 bg-[#FFB81A] transform transition-transform duration-300 ${pathname === '/institucional/autoridades' ? 'scale-x-100' : 'scale-x-0 hover:scale-x-100'
                                        }`}></span>
                                </Link>
                            </li>
